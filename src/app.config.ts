export default defineAppConfig({
  pages: [
    ...
    'pages/tools/vaccine-notes/index',
    'pages/tools/sleep-reference/index',
    'pages/tools/food-guide/index',
    'pages/tools/milestone/index',
